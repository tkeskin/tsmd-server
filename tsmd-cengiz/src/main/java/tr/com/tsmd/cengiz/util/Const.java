...
public class Const {
  public static final String SCHEMA = "tsmd";
  ...
  public static final String TABLE_VALUATIONPATENT = "valuationpatent";
  public static final String TABLE_VALUATIONTRADEMARK = "valuationtrademark";
  public static final String TABLE_ACTIVITYANALYSIS = "activityanalysis";
  public static final String TABLE_INVALIDATIONASSESSMENT = "invalidationassessment";
  public static final String TABLE_CONTACT_MAIL = "contactmail";
  ...
  public static final String TABLE_TRADEMARKPRE_VIEW_PDF = "trademarkpreviewpdf";
  public static final String TABLE_PATENTPRE_VIEW_PDF = "patentpreviewpdf";
  public static final String TABLE_ACTVITIYANALYSIS_VIEW_PDF = "activityanalysisviewpdf";
